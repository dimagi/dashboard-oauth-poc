...
export function getOAuthClient() {
  const clientId = process.env.REACT_APP_COMMCARE_CLIENT_ID;
  const clientSecret = process.env.REACT_APP_COMMCARE_CLIENT_SECRET;
  const redirectURI = process.env.REACT_APP_COMMCARE_REDIRECT_URI;
  const hqUrl = process.env.REACT_APP_COMMCARE_URL;
